...
namespace Austral\SocialNetworkBundle\DependencyInjection;
...
/**
 * Austral SocialNetwork Extension.
 * @author Matthieu Beurel <matthieu@austral.dev>
 * @final
 */
class AustralSocialNetworkExtension extends Extension
{
  /**
   * {@inheritdoc}
   * @throws Exception
  ...
  {
    return 'https://austral.app/schema/dic/austral_social_network';
  }
