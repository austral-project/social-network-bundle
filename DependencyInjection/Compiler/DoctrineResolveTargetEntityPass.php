...
namespace Austral\SocialNetworkBundle\DependencyInjection\Compiler;

use Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use Symfony\Component\DependencyInjection\ContainerBuilder;

/**
 * Austral SocialNetwork Load Doctrine Resolve.
...
class DoctrineResolveTargetEntityPass implements CompilerPassInterface
{
  ...
  public function process(ContainerBuilder $container)
  {
    ...
    $resolveTargetEntities = $container->getParameter("austral.resolve_target_entities.social_network");
